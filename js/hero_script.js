// console.log("Desktop Hero Script Loaded");

// /**
//  * Desktop Hero Interactions
//  * GPU-optimized cursor tracking and 3D tilt effects
//  */
...
//   // --- OPTIMIZATION 2: Single Mouse Listener for Cursor Light (Desktop Only) ---
//   if (canvas && !isMobile && !isTouchDevice) {
//     let tx = 0, ty = 0;
...
//   // --- OPTIMIZATION 3: Delegated & Calculated Tilt (Desktop Only) ---
//   letters.forEach(letter => {
//     const themeColor = letter.style.getPropertyValue('--theme');

//     // Only add interactions on desktop
