...
window.addEventListener("load", () => {
    ...
    // DESKTOP: -35 MOBILE: -45      yPercentage
    gsap.set('#flash-img', {
        xPercent: -50,
        yPercent: isMobileDevice ? -45 : -35,
        left: "50%",
        top: "50%",
        x: 0,
        y: 0,
...
function afterZoomIn() {
    ...
    if (hero) {
        ...
        gsap.to(hero, {
            opacity: 0,
            duration: 0.5, // Smooth fade out revealing the content underneath
            ease: "power2.inOut",
            onComplete: () => {
                hero.remove();
